package com.gideon.abiririderapp.Helper;
...
import com.gideon.abiririderapp.Home;
...
public class FirebaseHelper {
    ...
    public void showRegistrerDialog(){
        ...
        final MaterialEditText etEmail=registrer_layout.findViewById(R.id.edtEmail);
        final MaterialEditText etPassword=registrer_layout.findViewById(R.id.edtPassword);
        final MaterialEditText etName=registrer_layout.findViewById(R.id.edtName);
        final MaterialEditText etPhone=registrer_layout.findViewById(R.id.edtPhone);
